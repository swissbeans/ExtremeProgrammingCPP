...
//        for (int j = i; j < MAX; j++) {count++;
//            if (contains(permutations[i], permutations[j], '0', '1')) {
//                if (contains(permutations[i], permutations[j], '0', '4')) {
//                    if (contains(permutations[i], permutations[j], '0', '9')) {
//                        if (contains(permutations[i], permutations[j], '1', '6')) {
//                            if (contains(permutations[i], permutations[j], '2', '5')) {
//                                if (contains(permutations[i], permutations[j], '3', '6')) {
//                                    if (contains(permutations[i], permutations[j], '4', '9')) {
//                                        if (contains(permutations[i], permutations[j], '6', '4')) {
//                                            if (contains(permutations[i], permutations[j], '8', '1')) {
//                                                
//                                            }
//                                        }
//                                    }
